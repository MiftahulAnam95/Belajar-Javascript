  ...
  const renderNav = () => {
    ...
    target.innerHTML = `
      <nav class="navbar navbar-expand-lg app-navbar sticky-top">
        <div class="container">
          <a class="navbar-brand" href="${rootPath}index.html" aria-label="JavaScript Beginner Lab">
            <span class="brand-mark" aria-hidden="true">
              <svg viewBox="0 0 72 72" role="img" focusable="false">
                <rect x="8" y="12" width="56" height="52" rx="10" fill="#fde68a" opacity="0.9" />
                ...
                <circle cx="18" cy="16" r="3.1" fill="#facc15" />
                <circle cx="27" cy="16" r="3.1" fill="#06b6d4" />
                <circle cx="36" cy="16" r="3.1" fill="#22c55e" />
                <path d="M22 37H49" fill="none" stroke="#f59e0b" stroke-width="5.4" stroke-linecap="round" />
            ...
            <span class="brand-text">
              <strong>JavaScript Beginner Lab</strong>
              <small>Lanjutan HTML & CSS</small>
            </span>
          </a>
...
document.addEventListener("DOMContentLoaded", window.JSLabLayout.init);
